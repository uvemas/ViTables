...
extensions = ['rst2pdf.pdfbuilder', 'sphinx.ext.autodoc',
              'sphinx.ext.viewcode', 'sphinx.ext.todo', 'sphinx.ext.coverage']
...
htmlhelp_basename = 'ViTablesUsersGuidedoc'
...
# the title page.
latex_logo = 'images/title_page_plain.png'
